    ...
    const iconMap: Record<string, any> = {
      'blog-header': (
        <svg viewBox="0 0 80 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect x="16" y="18" width="48" height="4" rx="1" fill="currentColor" opacity="0.5"/>
        </svg>
      ),
      'blog-article': (
        <svg viewBox="0 0 80 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Content lines */}
          <rect x="8" y="14" width="64" height="2" rx="0.5" fill="currentColor" opacity="0.6"/>
          <rect x="8" y="19" width="60" height="2" rx="0.5" fill="currentColor" opacity="0.6"/>
          <rect x="8" y="24" width="56" height="2" rx="0.5" fill="currentColor" opacity="0.6"/>
          <rect x="8" y="29" width="52" height="2" rx="0.5" fill="currentColor" opacity="0.6"/>
          {/* Author/date info */}
          <rect x="8" y="38" width="24" height="2" rx="0.5" fill="currentColor" opacity="0.4"/>
          <rect x="36" y="38" width="20" height="2" rx="0.5" fill="currentColor" opacity="0.4"/>
        </svg>
      ),
      'blog-button': (
        <svg viewBox="0 0 80 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Button background */}
          <rect x="16" y="6" width="48" height="12" rx="6" fill="currentColor"/>
          {/* Button label text */}
          <rect x="28" y="10" width="24" height="4" rx="1" fill="white" opacity="0.9"/>
        </svg>
      ),
    };

    return iconMap[this.componentType] || <span class="palette-icon-emoji">{this.icon}</span>;
  }
