 ...
 */
export declare class VirtualRendererService {
    /**
     ...
     * ```
     */
    observe(element: HTMLElement, elementId: string, callback: VisibilityCallback): void;
    /**
     ...
     * ```
     */
    unobserve(element: HTMLElement, elementId: string): void;
    /**
 ...
 * ```
 */
export declare const virtualRenderer: VirtualRendererService;
