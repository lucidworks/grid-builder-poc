...
import { GridBuilderEventMap } from '../types/events';
/**
 ...
 */
export declare class GridBuilderAPI {
     ...
     */
    getCanvases(): Record<string, import("./state-manager").Canvas>;
    /**
     ...
     */
    getCanvas(canvasId: string): import("./state-manager").Canvas;
    /**
     ...
     */
    getCurrentViewport(): "desktop" | "mobile";
    /**
     ...
     * @emits itemAdded
     */
    addItem(canvasId: string, componentType: string, x: number, y: number, width: number, height: number, config?: Record<string, any>): GridItem;
    /**
