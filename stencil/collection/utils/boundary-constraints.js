 ...
 * ```
 */
export function canComponentFitCanvas(definition, canvasWidth = CANVAS_WIDTH_UNITS) {
    var _a;
 ...
 * ```
 */
export function constrainSizeToCanvas(definition, canvasWidth = CANVAS_WIDTH_UNITS) {
    var _a, _b, _c, _d;
 ...
 * ```
 */
export function constrainPositionToCanvas(x, y, width, height, canvasWidth = CANVAS_WIDTH_UNITS) {
    let newX = x;
    let newY = y;
 ...
 * ```
 */
export function applyBoundaryConstraints(definition, x, y, canvasWidth = CANVAS_WIDTH_UNITS) {
    var _a;
...
//# sourceMappingURL=boundary-constraints.js.map
