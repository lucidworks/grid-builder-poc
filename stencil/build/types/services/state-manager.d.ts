 ...
 * ```
 */
declare const state: GridState, onChange: import("@stencil/store/dist/types").OnChangeHandler<GridState>, dispose: () => void;
/**
 ...
 * ```
 */
export declare function addItemToCanvas(canvasId: string, item: GridItem): void;
/**
 ...
 * ```
 */
export declare function removeItemFromCanvas(canvasId: string, itemId: string): void;
/**
 ...
 * ```
 */
export declare function updateItem(canvasId: string, itemId: string, updates: Partial<GridItem>): void;
/**
 * Get item by ID
 *
 * **Use cases**:
 ...
 * ```
 */
export declare function getItem(canvasId: string, itemId: string): GridItem | null;
/**
 ...
 * ```
 */
export declare function moveItemToCanvas(fromCanvasId: string, toCanvasId: string, itemId: string): void;
/**
 ...
 */
export declare let itemIdCounter: number;
/**
 ...
 * ```
 */
export declare function selectItem(itemId: string, canvasId: string): void;
/**
 ...
 * ```
 */
export declare function deselectItem(): void;
/**
 * Set active canvas
 *
 * **Use cases**:
 ...
 * ```
 */
export declare function setActiveCanvas(canvasId: string): void;
/**
 * Clear active canvas
 *
 * **Use cases**:
 ...
 * ```
 */
export declare function clearActiveCanvas(): void;
/**
 * Batch Operations
 * =================
 *
 ...
 * ```
 */
export declare function addItemsBatch(items: Partial<GridItem>[]): string[];
/**
 ...
 * ```
 */
export declare function deleteItemsBatch(itemIds: string[]): void;
/**
 ...
 * ```
 */
export declare function updateItemsBatch(updates: Array<{
    itemId: string;
    canvasId: string;
