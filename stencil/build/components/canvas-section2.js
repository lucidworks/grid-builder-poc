...
import { a as setActiveCanvas, s as state, o as onChange } from './event-manager.js';
import { c as clearGridSizeCache, b as gridToPixelsX, g as gridToPixelsY, d as getGridSizeVertical } from './grid-calculations.js';
import { c as calculateCanvasHeight } from './canvas-height-calculator.js';
import { d as defineCustomElement$1 } from './grid-item-wrapper2.js';
...
const CanvasSection = /*@__PURE__*/ proxyCustomElement(class CanvasSection extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '3dc37262a5f15cf588dc292cb61cbb67ed865cf9', class: "canvas-section", "data-canvas-id": this.canvasId }, h("div", { key: '9a5ad4c2ccc630070eefca751d9c5c0d6aa4490f', class: {
                'grid-container': true,
                'hide-grid': !showGrid,
...
function defineCustomElement() {
    ...
    const components = ["canvas-section", "grid-item-wrapper"];
    components.forEach(tagName => { switch (tagName) {
        case "canvas-section":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, CanvasSection);
            }
            break;
...
export { CanvasSection as C, defineCustomElement as d };
//# sourceMappingURL=canvas-section2.js.map
