...
import { s as state, e as eventManager } from './event-manager.js';
...
const ConfigPanel$1 = /*@__PURE__*/ proxyCustomElement(class ConfigPanel extends HTMLElement {
    ...
    static get style() { return configPanelCss; }
}, [256, "config-panel", {
        ...
        "componentName": [32],
        "componentConfig": [32]
    }, [[4, "item-click", "handleItemClick"]]]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["config-panel"];
    components.forEach(tagName => { switch (tagName) {
        case "config-panel":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ConfigPanel$1);
            }
            break;
    } });
}

const ConfigPanel = ConfigPanel$1;
const defineCustomElement = defineCustomElement$1;

export { ConfigPanel, defineCustomElement };
