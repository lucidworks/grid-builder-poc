...
const componentTemplates = {
    ...
    image: {
        icon: '🖼️',
        title: 'Image',
        content: '<div style="position: relative; width: 100%; height: 0; padding-bottom: 75%; overflow: hidden; border-radius: 4px; background: #f0f0f0;"><img src="https://picsum.photos/800/600?random=' +
            Math.random() +
    ...
    video: {
        icon: '🎥',
        title: 'Video',
        content: '<div class="video-placeholder" style="width: 100%; height: 100%; background: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url(\'https://picsum.photos/400/300?random=' +
            Math.random() +
...
export { componentTemplates as c };

//# sourceMappingURL=component-templates-e71f1a8f.js.map