 ...
 * ```
 */
export function addItemToCanvas(canvasId, item) {
 ...
 * ```
 */
export function removeItemFromCanvas(canvasId, itemId) {
    const canvas = state.canvases[canvasId];
    if (!canvas) {
        return;
    }
 ...
 * ```
 */
export function updateItem(canvasId, itemId, updates) {
    const canvas = state.canvases[canvasId];
    if (!canvas) {
        return;
    }
 ...
 * ```
 */
export function getItem(canvasId, itemId) {
    const canvas = state.canvases[canvasId];
    if (!canvas) {
        return null;
    }
 ...
 * ```
 */
export function moveItemToCanvas(fromCanvasId, toCanvasId, itemId) {
 ...
 * ```
 */
export function selectItem(itemId, canvasId) {
 ...
 * ```
 */
export function setActiveCanvas(canvasId) {
 ...
 * ```
 */
export function addItemsBatch(items) {
    const itemIds = [];
 ...
 * ```
 */
export function deleteItemsBatch(itemIds) {
 ...
 * ```
 */
export function updateItemsBatch(updates) {
    const updatedCanvases = Object.assign({}, state.canvases);
