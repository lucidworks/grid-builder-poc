 ...
 */
import { addItemToCanvas, gridState, updateItem as updateItemInState, deleteItemsBatch, updateItemsBatch, } from "./state-manager";
 ...
 */
export class ToggleGridCommand {
 ...
 * - Single state update, single re-render
 */
export class BatchUpdateConfigCommand {
    constructor(updates) {
 ...
 * @module undo-redo-commands
 */
export class RemoveCanvasCommand {
    constructor(canvasId) {
...
//# sourceMappingURL=undo-redo-commands.js.map
