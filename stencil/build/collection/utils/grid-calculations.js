 ...
 * ```
 */
export function getGridSizeHorizontal(canvasId, config, forceRecalc = false) {
    var _a, _b;
 ...
 * ```
 */
export function getGridSizeVertical(config) {
    var _a;
 ...
 * ```
 */
export function gridToPixelsX(gridUnits, canvasId, config) {
 ...
 * ```
 */
export function gridToPixelsY(gridUnits, config) {
 ...
 * ```
 */
export function pixelsToGridX(pixels, canvasId, config) {
    // Use cached grid size for better performance
    const gridSize = getGridSizeHorizontal(canvasId, config);
    if (gridSize === 0) {
        return 0;
 ...
 * ```
 */
export function pixelsToGridY(pixels, config) {
    return Math.round(pixels / getGridSizeVertical(config));
}
//# sourceMappingURL=grid-calculations.js.map
