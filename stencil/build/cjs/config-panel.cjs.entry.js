...
const ConfigPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '52b2ecd551004067b06330ea5839785de02a8cd3', class: panelClasses }, index.h("div", { key: '661d6ba0066e7c656ea4ea74774bf457ab59d0e5', class: "config-panel-header" }, index.h("h2", { key: '1019f65d5458dc24e52a156cfe6769c0d1673314' }, "Component Settings"), index.h("button", { key: '6c5a7c5a333ae28552efd0d1a8018446b3dba951', class: "config-panel-close", onClick: () => this.closePanel() }, "\u00D7")), index.h("div", { key: '8f57fb76f0555c96fd35018d6222e889bc3b3898', class: "config-panel-body" }, index.h("div", { key: '4118aee32af74c90a2f166c36d701c825782810b', class: "config-field" }, index.h("label", { key: 'b936c28c7876bcd34b2685474a6fc73d005e7c06', htmlFor: "componentName" }, "Component Name"), index.h("input", { key: '7eb341db95aa1dff588e291e6b6b2debd56dc748', type: "text", id: "componentName", value: this.componentName, onInput: (e) => this.handleNameInput(e), placeholder: "Enter component name" })), definition && this.renderConfigFields(definition), index.h("div", { key: 'af76c8b525d70a8d1b2e6f3fa60635a959457d9d', class: "config-field" }, index.h("label", { key: '7116f72ebd474a052bf04b3ed115e4b0463ecac4' }, "Layer Order"), index.h("div", { key: 'b93caa73c1304cac3cfca6d58a52de0d53ac0890', class: "z-index-controls" }, index.h("button", { key: 'b0fd3ff3455069f539681a6a521248c8d0f6d0f0', class: "z-index-btn", onClick: () => this.bringToFront(), title: "Bring to Front" }, "\u2B06\uFE0F To Front"), index.h("button", { key: 'b0da4193c5ba400149014a3769fbe7eea8f06559', class: "z-index-btn", onClick: () => this.bringForward(), title: "Bring Forward" }, "\u2191 Forward"), index.h("button", { key: 'b6eda279841adb228be85c20ed662506fe2e7c84', class: "z-index-btn", onClick: () => this.sendBackward(), title: "Send Backward" }, "\u2193 Backward"), index.h("button", { key: '0135901b5bb6fc61b73047e4df894cda0c3f10dc', class: "z-index-btn", onClick: () => this.sendToBack(), title: "Send to Back" }, "\u2B07\uFE0F To Back")))), index.h("div", { key: '3d9afe05e042359a2c86257b62d43963da8a1902', class: "config-panel-footer" }, index.h("button", { key: 'eee93819521c968005ba70d1476a093323895c40', onClick: () => this.closePanel() }, "Cancel"), index.h("button", { key: 'f13b1c0cf2722a3b577f9728560837bc7b79e3c1', class: "primary", onClick: () => this.saveConfig() }, "Save"))));
    }
    /**
