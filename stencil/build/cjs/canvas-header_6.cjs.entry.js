...
var componentDefinitions = require('./component-definitions-l1YP7dC1.js');
var interact_min = require('./interact.min-DyhD2Nx0.js');
...
const CanvasHeader = class {
    constructor(hostRef) {
        ...
        this.headerClick = index.createEvent(this, "headerClick");
        this.deleteClick = index.createEvent(this, "deleteClick");
        /**
     ...
     */
    render() {
        return (index.h("div", { key: '2a7fabfa2f2e867a65353474ec3fb007fdd3c538', class: "canvas-header", "data-canvas-id": this.canvasId }, index.h("div", { key: '378efc96d7355779eb368091b254c263bb300346', class: "canvas-actions" }, index.h("span", { key: '043fb4d06223ae22d5a49675561f3a00078300fa', class: "canvas-title", onClick: this.handleTitleClick }, this.sectionTitle), this.isDeletable && (index.h("button", { key: '4faad29f7c56074b5ab2749e19088459e81de3aa', class: "delete-canvas-btn", title: "Delete this section", onClick: this.handleDeleteClick }, "\u00D7")))));
    }
};
...
const ConfirmationModal = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.confirm = index.createEvent(this, "confirm");
    ...
    render() {
        ...
        return (index.h("div", { class: "confirmation-overlay", onClick: this.handleCancel }, index.h("div", { class: "confirmation-modal", onClick: (e) => e.stopPropagation() }, index.h("div", { class: "modal-header" }, index.h("h2", { class: "modal-title" }, this.data.title)), index.h("div", { class: "modal-body" }, index.h("p", { class: "modal-message" }, this.data.message)), index.h("div", { class: "modal-footer" }, index.h("button", { class: "cancel-btn", onClick: this.handleCancel }, "Cancel"), index.h("button", { class: "confirm-btn", onClick: this.handleConfirm }, "Delete")))));
    }
};
...
const CustomConfigPanel = class {
    ...
    componentDidLoad() {
        ...
        this.componentRegistry = new Map(componentDefinitions.blogComponentDefinitions.map(def => [def.type, def]));
    ...
    render() {
        ...
        return (index.h("div", { class: panelClasses }, index.h("div", { class: "custom-panel-header" }, index.h("div", { class: "header-content" }, index.h("span", { class: "component-icon" }, definition.icon), index.h("h2", null, "Edit Component")), index.h("button", { class: "close-btn", onClick: () => this.closePanel(), title: "Close" }, "\u2715")), index.h("div", { class: "custom-panel-body" }, index.h("div", { class: "config-section" }, index.h("label", { class: "section-label" }, "Component Name"), index.h("input", { type: "text", class: "text-input", value: this.componentName, placeholder: "Enter component name", onInput: (e) => this.handleNameChange(e) })), index.h("div", { class: "config-section info-section" }, index.h("div", { class: "info-row" }, index.h("span", { class: "info-label" }, "Type:"), index.h("span", { class: "info-value" }, definition.name)), index.h("div", { class: "info-row" }, index.h("span", { class: "info-label" }, "ID:"), index.h("span", { class: "info-value" }, item.id))), definition.configSchema && definition.configSchema.length > 0 ? (index.h("div", { class: "config-section" }, index.h("label", { class: "section-label" }, "Configuration"), definition.configSchema.map((field) => (index.h("div", { class: "config-field", key: field.name }, index.h("label", { class: "field-label" }, field.label), this.renderConfigField(field)))))) : (index.h("div", { class: "config-section" }, index.h("p", { class: "no-config-message" }, "No configuration options available for this component.")))), index.h("div", { class: "custom-panel-footer" }, index.h("button", { class: "btn btn-secondary", onClick: () => this.closePanel() }, "Cancel"), index.h("button", { class: "btn btn-primary", onClick: () => this.saveConfig() }, "Save Changes"))));
    }
    /**
    ...
    renderConfigField(field) {
        ...
        switch (field.type) {
            case 'text':
            case 'textarea':
                return (index.h("input", { type: "text", class: "text-input", value: value, onInput: (e) => this.handleConfigChange(field.name, e.target.value), placeholder: field.placeholder }));
            case 'number':
                return (index.h("input", { type: "number", class: "text-input", value: value, onInput: (e) => this.handleConfigChange(field.name, Number(e.target.value)), min: field.min, max: field.max, step: field.step }));
            case 'select':
                return (index.h("select", { class: "select-input", onChange: (e) => this.handleConfigChange(field.name, e.target.value) }, (_c = field.options) === null || _c === void 0 ? void 0 : _c.map((option) => {
                    const optionValue = typeof option === 'string' ? option : option.value;
                    const optionLabel = typeof option === 'string' ? option : option.label;
                    return (index.h("option", { key: optionValue, value: optionValue, selected: value === optionValue }, optionLabel));
                })));
            case 'checkbox':
                return (index.h("label", { class: "checkbox-label" }, index.h("input", { type: "checkbox", checked: !!value, onChange: (e) => this.handleConfigChange(field.name, e.target.checked) }), index.h("span", { class: "checkbox-text" }, field.label)));
            case 'color':
                return (index.h("div", { class: "color-input-wrapper" }, index.h("input", { type: "color", class: "color-input", value: value, onInput: (e) => this.handleConfigChange(field.name, e.target.value) }), index.h("span", { class: "color-value" }, value)));
            default:
                return index.h("p", { class: "field-error" }, "Unknown field type: ", field.type);
        }
    }
...
const debug$1 = boundaryConstraints.createDebugLogger('grid-builder');
const GridBuilder = class {
        ...
        this.setupViewportResizeObserver = () => {
            ...
            this.viewportResizeObserver = new ResizeObserver((entries) => {
                ...
                for (const entry of entries) {
                    ...
                    if (stateManager.state.currentViewport !== targetViewport) {
                        debug$1.log(`📱 Container-based viewport switch: ${stateManager.state.currentViewport} → ${targetViewport} (width: ${Math.round(width)}px)`);
                        stateManager.state.currentViewport = targetViewport;
                    }
                }
            });
    ...
    componentWillLoad() {
        ...
        window.interact = interact_min.interact;
        // Restore initial state if provided
        if (this.initialState) {
            Object.assign(stateManager.state, this.initialState);
        }
    }
    /**
    ...
    componentDidLoad() {
        ...
        window.virtualRenderer = boundaryConstraints.virtualRenderer;
        ...
        eventManager.eventManager.setDebounceDelay(debounceDelay);
        debug$1.log(`GridBuilder: Event debounce delay set to ${debounceDelay}ms`);
        // Debug helper
        window.debugInteractables = () => {
            const interactables = interact_min.interact.interactables.list;
        ...
        this.canvasDropHandler = (event) => {
            ...
            const gridX = gridCalculations.pixelsToGridX(x, canvasId, this.config);
            const gridY = gridCalculations.pixelsToGridY(y, this.config);
            ...
            const constrained = boundaryConstraints.applyBoundaryConstraints(definition, gridX, gridY);
            if (!constrained) {
        ...
        this.canvasMoveHandler = (event) => {
            ...
            const sourceCanvas = stateManager.state.canvases[sourceCanvasId];
            if (!sourceCanvas) {
            ...
            let gridX = gridCalculations.pixelsToGridX(x, targetCanvasId, this.config);
            let gridY = gridCalculations.pixelsToGridY(y, this.config);
            // 4. Constrain position to target canvas boundaries
            const constrained = boundaryConstraints.constrainPositionToCanvas(gridX, gridY, item.layouts.desktop.width, item.layouts.desktop.height, boundaryConstraints.CANVAS_WIDTH_UNITS);
            gridX = constrained.x;
            gridY = constrained.y;
            ...
            stateManager.moveItemToCanvas(sourceCanvasId, targetCanvasId, itemId);
            // 7. Assign new z-index in target canvas
            const targetCanvas = stateManager.state.canvases[targetCanvasId];
            item.zIndex = targetCanvas.zIndexCounter++;
            stateManager.state.canvases = Object.assign({}, stateManager.state.canvases); // Trigger reactivity
            // 8. Set target canvas as active
            stateManager.setActiveCanvas(targetCanvasId);
            // 9. Update selection state if item was selected
            if (stateManager.state.selectedItemId === itemId) {
                stateManager.state.selectedCanvasId = targetCanvasId;
            }
            // 10. Create undo/redo command
            const command = new boundaryConstraints.MoveItemCommand(itemId, sourceCanvasId, targetCanvasId, sourcePosition, targetPosition, itemIndex);
            boundaryConstraints.undoRedo.push(command);
            // 11. Emit events for plugins
            eventManager.eventManager.emit('componentMoved', {
                item,
                sourceCanvasId,
                targetCanvasId,
                position: targetPosition
            });
            eventManager.eventManager.emit('canvasActivated', { canvasId: targetCanvasId });
        ...
        this.canvasActivatedHandler = (event) => {
            ...
            // Emit plugin event
            eventManager.eventManager.emit('canvasActivated', { canvasId });
        };
        ...
        this.keyboardHandler = (event) => {
            ...
            if (!stateManager.state.selectedItemId || !stateManager.state.selectedCanvasId) {
                return;
            }
            ...
            event.preventDefault();
            // Get selected item
            const canvas = stateManager.state.canvases[stateManager.state.selectedCanvasId];
            if (!canvas) {
                return;
            }
            const item = canvas.items.find(i => i.id === stateManager.state.selectedItemId);
            if (!item) {
                return;
            }
            // Get current viewport layout
            const viewport = stateManager.state.currentViewport;
            ...
            const nudgeCommand = new boundaryConstraints.MoveItemCommand(item.id, stateManager.state.selectedCanvasId, stateManager.state.selectedCanvasId, { x: oldX, y: oldY }, { x: constrainedX, y: constrainedY }, canvas.items.findIndex(i => i.id === item.id));
            boundaryConstraints.undoRedo.push(nudgeCommand);
            // Trigger state update
            stateManager.state.canvases = Object.assign({}, stateManager.state.canvases);
            // Emit event
            eventManager.eventManager.emit('componentDragged', {
                itemId: item.id,
                canvasId: stateManager.state.selectedCanvasId,
    ...
    createAPI() {
        return {
            ...
            on: (eventName, callback) => {
                eventManager.eventManager.on(eventName, callback);
            },
            off: (eventName, callback) => {
                eventManager.eventManager.off(eventName, callback);
            },
            // ======================
            // State Access (Read)
            // ======================
            ...
            getItems: (canvasId) => {
                var _a;
                return ((_a = stateManager.state.canvases[canvasId]) === null || _a === void 0 ? void 0 : _a.items) || [];
            },
            getItem: (itemId) => {
                // Search across all canvases
                for (const canvasId in stateManager.state.canvases) {
                    const canvas = stateManager.state.canvases[canvasId];
            ...
            addComponent: (canvasId, componentType, position, config) => {
                ...
                boundaryConstraints.undoRedo.push(new boundaryConstraints.BatchAddCommand([newItem.id]));
                // Emit event
                eventManager.eventManager.emit('componentAdded', { item: newItem, canvasId });
                return newItem.id;
            },
            deleteComponent: (itemId) => {
                ...
                for (const canvasId in stateManager.state.canvases) {
                    ...
                    if (itemIndex !== -1) {
                        ...
                        boundaryConstraints.undoRedo.push(new boundaryConstraints.BatchDeleteCommand([itemId]));
                        // Delete item
                        canvas.items.splice(itemIndex, 1);
                        stateManager.state.canvases = Object.assign({}, stateManager.state.canvases);
                        // Deselect if deleted item was selected
                        if (stateManager.state.selectedItemId === itemId) {
                            stateManager.state.selectedItemId = null;
                            stateManager.state.selectedCanvasId = null;
                        }
                        // Emit event
                        eventManager.eventManager.emit('componentDeleted', { itemId, canvasId });
                        return true;
                    }
                }
                return false;
            ...
            updateConfig: (itemId, config) => {
                ...
                for (const canvasId in stateManager.state.canvases) {
                    ...
                    if (itemIndex !== -1) {
                        ...
                        boundaryConstraints.undoRedo.push(new boundaryConstraints.BatchUpdateConfigCommand(batchUpdate));
                        // Merge config
                        canvas.items[itemIndex] = Object.assign(Object.assign({}, canvas.items[itemIndex]), { config: newConfig });
                        stateManager.state.canvases = Object.assign({}, stateManager.state.canvases);
                        // Emit event
                        eventManager.eventManager.emit('configChanged', { itemId, canvasId, config });
                        return true;
                    }
                }
                return false;
            ...
            addComponentsBatch: (components) => {
                ...
                const itemIds = stateManager.addItemsBatch(partialItems);
                // Add to undo/redo history
                boundaryConstraints.undoRedo.push(new boundaryConstraints.BatchAddCommand(itemIds));
                // Emit batch event
                ...
                eventManager.eventManager.emit('componentsBatchAdded', { items: createdItems });
                return itemIds;
            },
            deleteComponentsBatch: (itemIds) => {
                ...
                // Add to undo/redo history BEFORE deletion (need state for undo)
                boundaryConstraints.undoRedo.push(new boundaryConstraints.BatchDeleteCommand(itemIds));
                // Use state-manager batch operation (single state update)
                stateManager.deleteItemsBatch(itemIds);
                // Clear selection if any deleted item was selected
                if (stateManager.state.selectedItemId && itemIds.includes(stateManager.state.selectedItemId)) {
                    stateManager.state.selectedItemId = null;
                    stateManager.state.selectedCanvasId = null;
                }
                // Emit batch event
                eventManager.eventManager.emit('componentsBatchDeleted', { items: deletedItems });
            },
            updateConfigsBatch: (updates) => {
                ...
                // Add to undo/redo history
                boundaryConstraints.undoRedo.push(new boundaryConstraints.BatchUpdateConfigCommand(batchUpdates));
                // Use state-manager batch operation (single state update)
                stateManager.updateItemsBatch(batchUpdates);
                // Emit batch event
                ...
                eventManager.eventManager.emit('configsBatchChanged', { items: updatedItems });
            },
            // ======================
            // Canvas Access
            // ======================
            ...
            // ======================
            undo: () => {
                boundaryConstraints.undoRedo.undo();
                // Emit event after undo
                eventManager.eventManager.emit('undoExecuted', {});
            },
            redo: () => {
                boundaryConstraints.undoRedo.redo();
                // Emit event after redo
                eventManager.eventManager.emit('redoExecuted', {});
            },
            canUndo: () => {
                return boundaryConstraints.undoRedo.canUndo();
            },
            canRedo: () => {
                return boundaryConstraints.undoRedo.canRedo();
            },
            undoRedoState: boundaryConstraints.undoRedoState,
            // ======================
            // Canvas Management
            // ======================
            addCanvas: (canvasId) => {
                // Create and execute command
                const command = new boundaryConstraints.AddCanvasCommand(canvasId);
                boundaryConstraints.undoRedo.push(command);
                command.redo();
            },
            removeCanvas: (canvasId) => {
                // Create and execute command
                const command = new boundaryConstraints.RemoveCanvasCommand(canvasId);
                boundaryConstraints.undoRedo.push(command);
                command.redo();
            },
            ...
            getActiveCanvas: () => {
                return stateManager.state.activeCanvasId;
            },
        };
    }
    /**
    ...
    async exportState() {
        ...
        const exportData = {
            version: '1.0.0',
            canvases: {},
            viewport: stateManager.state.currentViewport,
            metadata: {
     ...
     */
    render() {
        const canvasIds = Object.keys(stateManager.state.canvases);
        return (index.h(index.Host, { key: '41f88f4f0486a63bbbe473fb738b3ac2ae21ecc9', ref: (el) => this.el = el }, index.h("div", { key: 'dbcda54b31a36ee34522ef697892dd4628d717b3', class: "grid-builder-container" }, index.h("div", { key: '9a59401dd27a47b88558a791b80a084f4ac90e7e', class: "palette-area" }, index.h("component-palette", { key: '3b83fa7ec7e23bf61a64b4361d39368c3a028b08', components: this.components, config: this.config })), index.h("div", { key: 'e7366c25649d47699d8e0e5816656d04280abc68', class: "canvas-area" }, index.h("div", { key: '99ee6f4776120765eaa81a09f166af999deab27d', class: "canvases-container" }, canvasIds.map((canvasId) => {
            var _a, _b, _c, _d;
            return (index.h("canvas-section", { key: canvasId, canvasId: canvasId, isActive: stateManager.state.activeCanvasId === canvasId, config: this.config, componentRegistry: this.componentRegistry, backgroundColor: (_b = (_a = this.canvasMetadata) === null || _a === void 0 ? void 0 : _a[canvasId]) === null || _b === void 0 ? void 0 : _b.backgroundColor, canvasTitle: (_d = (_c = this.canvasMetadata) === null || _c === void 0 ? void 0 : _c[canvasId]) === null || _d === void 0 ? void 0 : _d.title, onBeforeDelete: this.onBeforeDelete }));
        }))))));
    }
...
const debug = boundaryConstraints.createDebugLogger('grid-viewer');
const GridViewer = class {
    ...
    componentWillLoad() {
        ...
        this.viewerState = stateManager.createStore(initialViewerState);
    }
    /**
     * Component did load lifecycle
     *
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '243907a7615c3c4eb7263383337b26d9131236d0', ref: (el) => this.el = el }, index.h("div", { key: '8d4eb74201dc529163348967d25a05f031b088b1', class: "grid-viewer-container" }, index.h("div", { key: '287bcfbbf3b430201f239f83da3fd4afc1c6df6d', class: "canvas-area" }, index.h("div", { key: 'd72dda890861e7de3bf25983d0c082b6c758a424', class: "canvases-container" }, canvasIds.map((canvasId) => {
            var _a, _b;
            return (index.h("canvas-section-viewer", { key: canvasId, canvasId: canvasId, config: this.config, componentRegistry: this.componentRegistry, items: this.viewerState.state.canvases[canvasId].items, currentViewport: this.viewerState.state.currentViewport, backgroundColor: (_b = (_a = this.canvasMetadata) === null || _a === void 0 ? void 0 : _a[canvasId]) === null || _b === void 0 ? void 0 : _b.backgroundColor }));
        }))))));
    }
    get hostElement() { return index.getElement(this); }
    static get watchers() { return {
...
const SectionEditorPanel = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.closePanel = index.createEvent(this, "closePanel");
        this.updateSection = index.createEvent(this, "updateSection");
        this.previewColorChange = index.createEvent(this, "previewColorChange");
        this.previewTitleChange = index.createEvent(this, "previewTitleChange");
        this.deleteSection = index.createEvent(this, "deleteSection");
        /**
         * Panel open/closed state
         * Controlled by parent component (blog-app)
         */
    ...
    render() {
        ...
        return (index.h("div", { class: "section-editor-overlay", onClick: this.handleClose }, index.h("div", { class: "section-editor-panel", onClick: (e) => e.stopPropagation() }, index.h("div", { class: "panel-header" }, index.h("h2", { class: "panel-title" }, "Edit Section"), index.h("button", { class: "close-btn", onClick: this.handleClose, title: "Close" }, "\u00D7")), index.h("div", { class: "panel-body" }, index.h("div", { class: "form-group" }, index.h("label", { htmlFor: "section-title" }, "Section Name"), index.h("input", { type: "text", id: "section-title", class: "section-title-input", value: this.editedTitle, onInput: this.handleTitleInput, placeholder: "Enter section name" })), index.h("div", { class: "form-group" }, index.h("label", { htmlFor: "section-color" }, "Background Color"), index.h("div", { class: "color-picker-wrapper" }, index.h("input", { type: "color", id: "section-color", class: "section-color-input", value: this.editedColor, onInput: this.handleColorInput }), index.h("input", { type: "text", class: "color-hex-input", value: this.editedColor, onInput: this.handleColorInput, placeholder: "#ffffff" })))), index.h("div", { class: "panel-footer" }, index.h("button", { class: "delete-btn", onClick: this.handleDelete }, "Delete Section"), index.h("div", { class: "footer-actions" }, index.h("button", { class: "cancel-btn", onClick: this.handleClose }, "Cancel"), index.h("button", { class: "save-btn", onClick: this.handleSave }, "Save Changes"))))));
    }
    static get watchers() { return {
...
exports.canvas_header = CanvasHeader;
exports.confirmation_modal = ConfirmationModal;
exports.custom_config_panel = CustomConfigPanel;
exports.grid_builder = GridBuilder;
exports.grid_viewer = GridViewer;
exports.section_editor_panel = SectionEditorPanel;
//# sourceMappingURL=canvas-header.confirmation-modal.custom-config-panel.grid-builder.grid-viewer.section-editor-panel.entry.cjs.js.map
