...
import { c as clearGridSizeCache, g as gridToPixelsY } from './grid-calculations.js';
import { a as calculateCanvasHeightFromItems } from './canvas-height-calculator.js';
...
const CanvasSectionViewer = /*@__PURE__*/ proxyCustomElement(class CanvasSectionViewer extends HTMLElement {
    ...
    static get style() { return canvasSectionViewerCss; }
}, [256, "canvas-section-viewer", {
...
function defineCustomElement() {
    ...
    const components = ["canvas-section-viewer", "grid-item-wrapper"];
    components.forEach(tagName => { switch (tagName) {
        case "canvas-section-viewer":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, CanvasSectionViewer);
            }
            break;
...
export { CanvasSectionViewer as C, defineCustomElement as d };
//# sourceMappingURL=canvas-section-viewer2.js.map
