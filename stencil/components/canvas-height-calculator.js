import { s as state } from './event-manager.js';
import { g as gridToPixelsY } from './grid-calculations.js';
...
function calculateCanvasHeight(canvasId, config) {
    ...
    const viewport = state.currentViewport || 'desktop';
    // Delegate to reusable function
    return calculateCanvasHeightFromItems(canvas.items, viewport, config);
}

export { calculateCanvasHeightFromItems as a, calculateCanvasHeight as c };
//# sourceMappingURL=canvas-height-calculator.js.map
