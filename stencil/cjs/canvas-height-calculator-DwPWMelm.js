 ...
 */
function calculateCanvasHeightFromItems(items, viewport, config) {
    var _a, _b, _c;
    ...
    for (const item of items) {
        ...
        const y = (_a = layout.y) !== null && _a !== void 0 ? _a : 0;
        const height = (_b = layout.height) !== null && _b !== void 0 ? _b : 0;
    ...
    const bottomMargin = (_c = config === null || config === void 0 ? void 0 : config.canvasBottomMargin) !== null && _c !== void 0 ? _c : DEFAULT_BOTTOM_MARGIN_GRID_UNITS;
    // Add bottom margin in grid units
    const totalGridUnits = bottommostY + bottomMargin;
    // Convert to pixels
    const heightPx = gridCalculations.gridToPixelsY(totalGridUnits, config);
    return heightPx;
}
/**
 ...
 * ```
 */
function calculateCanvasHeight(canvasId, config) {
    ...
    const viewport = stateManager.state.currentViewport || 'desktop';
...
exports.calculateCanvasHeightFromItems = calculateCanvasHeightFromItems;
//# sourceMappingURL=canvas-height-calculator-DwPWMelm.js.map
