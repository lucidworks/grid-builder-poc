...
const CanvasHeader = class {
     ...
     */
    render() {
        return (index.h("div", { key: 'c44e288f10ce16098fe519cbc4354254cb110012', class: "canvas-header", "data-canvas-id": this.canvasId }, index.h("div", { key: '73701d3d053fead4e623db300a10abeda0e1b513', class: "canvas-actions" }, index.h("span", { key: '031ebb4279bfe6b5aed68b486a3fe2295fdf54f9', class: "canvas-title", onClick: this.handleTitleClick }, this.sectionTitle), this.isDeletable && (index.h("button", { key: 'e6399922d59ff07d03a32c0ecb61b89886b49240', class: "delete-canvas-btn", title: "Delete this section", onClick: this.handleDeleteClick }, "\u00D7")))));
    }
};
