import { h } from './index-CoCbyscT.js';
...
const contentComponents = [
    {
        ...
        render: ({ config }) => (h("blog-header", { headerTitle: (config === null || config === void 0 ? void 0 : config.headerTitle) || "Default Header", subtitle: config === null || config === void 0 ? void 0 : config.subtitle, backgroundColor: config === null || config === void 0 ? void 0 : config.backgroundColor })),
    },
    {
        type: "blog-article",
        name: "Blog Article",
        ...
        render: ({ config }) => (h("blog-article", { content: (config === null || config === void 0 ? void 0 : config.content) || "Article content goes here", author: config === null || config === void 0 ? void 0 : config.author, date: config === null || config === void 0 ? void 0 : config.date, backgroundColor: config === null || config === void 0 ? void 0 : config.backgroundColor })),
    },
    {
        type: "blog-image",
        name: "Blog Image",
        ...
        render: ({ config }) => (h("blog-image", { src: (config === null || config === void 0 ? void 0 : config.src) ||
...
const interactiveComponents = [
    {
        ...
        render: ({ config }) => (h("blog-button", { label: (config === null || config === void 0 ? void 0 : config.label) || "Click me!", variant: (config === null || config === void 0 ? void 0 : config.variant) || "primary", href: config === null || config === void 0 ? void 0 : config.href, backgroundColor: config === null || config === void 0 ? void 0 : config.backgroundColor })),
    },
];
...
const mediaComponents = [
    {
        ...
        render: ({ config }) => (h("image-gallery", { imageCount: parseInt((config === null || config === void 0 ? void 0 : config.imageCount) || "6"), backgroundColor: config === null || config === void 0 ? void 0 : config.backgroundColor })),
    },
    {
        ...
        render: ({ config }) => (h("dashboard-widget", { backgroundColor: config === null || config === void 0 ? void 0 : config.backgroundColor })),
    },
    {
        type: "live-data",
        name: "Live Data",
        ...
        render: ({ config }) => (h("live-data", { backgroundColor: config === null || config === void 0 ? void 0 : config.backgroundColor })),
    },
];
...
const _blogComponentDefinitionsDetailed = [
    /**
     ...
     */
    {
        ...
        // Custom palette item with SVG preview
        renderPaletteItem: ({ componentType, name, icon }) => `<custom-palette-item
     ...
     */
    {
        ...
        render: ({ config }) => (h("blog-image", { src: (config === null || config === void 0 ? void 0 : config.src) ||
                "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=600&fit=crop", alt: (config === null || config === void 0 ? void 0 : config.alt) || "Placeholder image", caption: config === null || config === void 0 ? void 0 : config.caption, objectFit: (config === null || config === void 0 ? void 0 : config.objectFit) || "contain" })),
    },
];

export { blogComponentDefinitions as b, contentComponents as c, interactiveComponents as i, mediaComponents as m };
//# sourceMappingURL=component-definitions-ZVTe1Mmn.js.map
