...
class DragHandler {
     ...
     * ```
     */
    constructor(element, item, state, onUpdate, domCacheInstance, config, dragHandleElement, onDragMove) {
    ...
    handleDragEnd(event) {
        ...
        const latestItem = canvas === null || canvas === void 0 ? void 0 : canvas.items.find((i) => i.id === this.item.id);
...
const BUILD_TIMESTAMP = '2025-12-01T22:09:02.480Z';
...
class ResizeHandler {
     ...
     * ```
     */
    constructor(element, item, state, onUpdate, domCacheInstance, componentDefinition, config) {
...
const GridItemWrapper = class {
    constructor(hostRef) {
        ...
        this.handleItemUpdate = (updatedItem) => {
            ...
            if (this.itemSnapshot) {
                ...
                if (isDrag || isResize) {
                    ...
                    if (this.undoRedoManagerInstance) {
                        this.undoRedoManagerInstance.push(new MoveItemCommand(updatedItem.id, snapshot.canvasId, updatedItem.canvasId, {
                            x: snapshot.layouts.desktop.x,
                            y: snapshot.layouts.desktop.y,
                        }, {
                            x: updatedItem.layouts.desktop.x,
                            y: updatedItem.layouts.desktop.y,
                        }, sourceIndex, sourceZIndex, targetZIndex, 
            ...
            if (itemIndex !== -1) {
                ...
                const newItems = canvas.items.map((item, i) => i === itemIndex ? updatedItem : item);
                ...
                const newCanvases = Object.assign(Object.assign({}, canvases), { [this.item.canvasId]: newCanvas });
                // Update state
         ...
         */
        this.handleDelete = async (itemId, canvasId) => {
    ...
    componentDidLoad() {
        ...
        requestAnimationFrame(() => {
            var _a;
            if (((_a = this.config) === null || _a === void 0 ? void 0 : _a.enableVirtualRendering) !== false && this.virtualRendererInstance) {
        ...
        if (!this.viewerMode) {
            ...
            this.dragHandler = new DragHandler(this.itemRef, this.item, this.stateInstance, this.handleItemUpdate, this.domCacheInstance, this.config, headerElement, () => {
                this.wasDragged = true;
            });
            this.resizeHandler = new ResizeHandler(this.itemRef, this.item, this.stateInstance, this.handleItemUpdate, this.domCacheInstance, componentDefinition, this.config);
        }
    }
    /**
    ...
    handleConfigChange(newConfig, oldConfig) {
        ...
        if (!this.viewerMode && this.itemRef) {
            ...
            const componentDefinition = (_a = this.componentRegistry) === null || _a === void 0 ? void 0 : _a.get(this.item.type);
            const headerElement = this.itemRef.querySelector(".grid-item-header");
            this.dragHandler = new DragHandler(this.itemRef, this.item, this.stateInstance, this.handleItemUpdate, this.domCacheInstance, newConfig, headerElement, () => {
                this.wasDragged = true;
            });
            this.resizeHandler = new ResizeHandler(this.itemRef, this.item, this.stateInstance, this.handleItemUpdate, this.domCacheInstance, componentDefinition, newConfig);
    ...
    handleItemBringToFrontEvent(event) {
        ...
        const newItems = canvas.items.map(item => item.id === this.item.id ? Object.assign(Object.assign({}, item), { zIndex: maxZ + 1 }) : item);
        this.stateInstance.canvases = Object.assign(Object.assign({}, this.stateInstance.canvases), { [this.item.canvasId]: Object.assign(Object.assign({}, canvas), { items: newItems }) });
    }
    /**
    ...
    handleItemSendToBackEvent(event) {
        ...
        const newItems = canvas.items.map(item => item.id === this.item.id ? Object.assign(Object.assign({}, item), { zIndex: minZ - 1 }) : item);
        this.stateInstance.canvases = Object.assign(Object.assign({}, this.stateInstance.canvases), { [this.item.canvasId]: Object.assign(Object.assign({}, canvas), { items: newItems }) });
    }
    /**
    ...
    renderComponent() {
        ...
        if (!definition) {
            ...
            if ((_a = this.config) === null || _a === void 0 ? void 0 : _a.hideUnknownComponents) {
                debug.log(`GridItemWrapper: Hiding unknown component type "${this.item.type}" (hideUnknownComponents=true)`);
                return null; // Don't render anything
            }
            // Option 2: Use custom unknown component renderer
            if ((_b = this.config) === null || _b === void 0 ? void 0 : _b.renderUnknownComponent) {
                debug.log(`GridItemWrapper: Rendering custom unknown component for type "${this.item.type}"`);
                ...
                if (customRenderer instanceof HTMLElement) {
                    return (h("div", { ref: (el) => el && !el.hasChildNodes() && el.appendChild(customRenderer) }));
                }
        ...
        if (rendered instanceof HTMLElement) {
            return (h("div", { class: "component-wrapper", ref: (el) => el && !el.hasChildNodes() && el.appendChild(rendered) }));
        }
    ...
    render() {
        ...
        if (currentViewport === "mobile" && !this.item.layouts.mobile.customized) {
            ...
            const canvasItems = this.viewerMode
                ? this.canvasItems || []
                : ((_a = this.stateInstance.canvases[this.item.canvasId]) === null || _a === void 0 ? void 0 : _a.items) || [];
        ...
        const selectionColor = (definition === null || definition === void 0 ? void 0 : definition.selectionColor) ||
            ((_f = this.theme) === null || _f === void 0 ? void 0 : _f.selectionColor) ||
            "#f59e0b";
        // Get backgroundColor from config, or fall back to configSchema default
        const backgroundColorField = (_g = definition === null || definition === void 0 ? void 0 : definition.configSchema) === null || _g === void 0 ? void 0 : _g.find((f) => f.name === "backgroundColor");
        const backgroundColor = ((_h = this.item.config) === null || _h === void 0 ? void 0 : _h.backgroundColor) ||
            (backgroundColorField === null || backgroundColorField === void 0 ? void 0 : backgroundColorField.defaultValue) ||
            "transparent";
        const itemStyle = {
            ...
            "--animation-duration": `${(_k = (_j = this.config) === null || _j === void 0 ? void 0 : _j.animationDuration) !== null && _k !== void 0 ? _k : 100}ms`,
        ...
        if (definition === null || definition === void 0 ? void 0 : definition.renderItemWrapper) {
            ...
            return (h("div", { class: itemClasses, id: this.item.id, tabindex: this.viewerMode ? undefined : 0, "aria-selected": isSelected ? "true" : "false", "aria-describedby": ariaDescription ? descriptionId : undefined, "data-canvas-id": this.item.canvasId, "data-component-name": displayName, "data-viewer-mode": this.viewerMode ? "true" : "false", style: itemStyle, onClick: (e) => this.handleClick(e), ref: (el) => (this.itemRef = el) }, ariaDescription && (h("div", { id: descriptionId, class: "sr-only" }, ariaDescription)), customWrapper, h("div", { class: "resize-handle nw" }), h("div", { class: "resize-handle ne" }), h("div", { class: "resize-handle sw" }), h("div", { class: "resize-handle se" }), h("div", { class: "resize-handle n" }), h("div", { class: "resize-handle s" }), h("div", { class: "resize-handle e" }), h("div", { class: "resize-handle w" })));
        }
        // Default item wrapper
        return (h("div", { class: itemClasses, id: this.item.id, role: "group", "aria-label": `${displayName} component`, tabindex: this.viewerMode ? undefined : 0, "aria-selected": isSelected ? "true" : "false", "aria-describedby": ariaDescription ? descriptionId : undefined, "data-canvas-id": this.item.canvasId, "data-component-name": displayName, "data-viewer-mode": this.viewerMode ? "true" : "false", style: itemStyle, onClick: (e) => this.handleClick(e), ref: (el) => (this.itemRef = el) }, ariaDescription && (h("div", { id: descriptionId, class: "sr-only" }, ariaDescription)), !this.viewerMode && [
            /* Drag Handle */
            h("div", { class: "drag-handle", key: "drag-handle", "aria-label": `Drag ${displayName}`, role: "button", "aria-grabbed": false }),
            /* Item Header */
            h("div", { class: "grid-item-header", key: "header", "aria-label": `${displayName} component header` }, icon, " ", displayName),
            /* Item Controls */
            h("div", { class: "grid-item-controls", key: "controls" }, h("button", { class: "grid-item-delete", "aria-label": `Delete ${displayName} component`, onClick: () => this.handleDelete(itemIdForDelete, canvasIdForDelete) }, "\u00D7")),
        ], h("div", { class: "grid-item-content", id: contentSlotId, "data-component-type": this.item.type }, this.renderComponent()), !this.viewerMode && [
            h("div", { class: "resize-handle nw", key: "resize-nw", role: "slider", "aria-label": "Resize top-left corner", tabindex: -1 }),
            h("div", { class: "resize-handle ne", key: "resize-ne", role: "slider", "aria-label": "Resize top-right corner", tabindex: -1 }),
            h("div", { class: "resize-handle sw", key: "resize-sw", role: "slider", "aria-label": "Resize bottom-left corner", tabindex: -1 }),
            h("div", { class: "resize-handle se", key: "resize-se", role: "slider", "aria-label": "Resize bottom-right corner", tabindex: -1 }),
            h("div", { class: "resize-handle n", key: "resize-n", role: "slider", "aria-label": "Resize top edge", tabindex: -1 }),
            h("div", { class: "resize-handle s", key: "resize-s", role: "slider", "aria-label": "Resize bottom edge", tabindex: -1 }),
            h("div", { class: "resize-handle e", key: "resize-e", role: "slider", "aria-label": "Resize right edge", tabindex: -1 }),
            h("div", { class: "resize-handle w", key: "resize-w", role: "slider", "aria-label": "Resize left edge", tabindex: -1 }),
        ]));
    }
...
//# sourceMappingURL=grid-item-wrapper.entry.esm.js.map
