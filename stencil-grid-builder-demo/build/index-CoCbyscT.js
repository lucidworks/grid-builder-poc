const NAMESPACE = 'grid-builder';
const BUILD = /* grid-builder */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, asyncQueue: false, attachStyles: true, cloneNodeFix: false, constructableCSS: false, cssAnnotations: true, deserializer: false, devTools: true, element: false, event: true, experimentalScopedSlotChanges: false, experimentalSlotFixes: false, formAssociated: false, hasRenderFn: true, hostListener: true, hostListenerTarget: true, hostListenerTargetBody: false, hostListenerTargetDocument: true, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: true, hydrateClientSide: false, hydrateServerSide: false, hydratedAttribute: false, hydratedClass: true, hydratedSelectorName: "hydrated", initializeNextTick: false, invisiblePrehydration: true, isDebug: false, isDev: true, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: true, mode: false, observeAttribute: true, profile: true, prop: true, propBoolean: true, propChangeCallback: true, propMutable: false, propNumber: true, propString: true, reflect: false, scoped: false, scopedSlotTextContentFix: false, scriptDataOpts: false, serializer: false, shadowDelegatesFocus: false, shadowDom: false, slot: false, slotChildNodesFix: false, slotRelocation: false, state: true, style: true, svg: true, taskQueue: true, transformTagName: false, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: true, vdomListener: true, vdomPropOrAttr: true, vdomRef: true, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: false };
const Env = /* grid-builder */ {};

const globalScripts = () => {};
const globalStyles = "/**\n * Global Styles for Grid Builder Library\n * These styles are output as a separate CSS file\n *\n * Component-specific styles are loaded via styleUrl in each component's @Component decorator.\n * This follows the StencilJS pattern of scoped component styles.\n */\n* {\n  box-sizing: border-box;\n  padding: 0;\n  margin: 0;\n}\n\nbody {\n  background: #f5f5f5;\n  color: #333;\n  font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, Helvetica, Arial, sans-serif;\n  font-size: 14px;\n  line-height: 1.5;\n  overflow-x: hidden;\n}\n\ngrid-builder {\n  display: block;\n}\n\ncomponent-palette,\ncanvas-section,\ngrid-item-wrapper {\n  display: block;\n}";
...
export { BUILD as B, H, NAMESPACE as N, createEvent as a, bootstrapLazy as b, consoleDevInfo as c, getElement as d, Host as e, getRenderingRef as f, globalScripts as g, h, forceUpdate as i, promiseResolve as p, registerInstance as r, setNonce as s, win as w };
//# sourceMappingURL=index-CoCbyscT.js.map
