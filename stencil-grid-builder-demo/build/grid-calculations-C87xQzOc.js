 ...
 * ```
 */
function clearGridSizeCache(instanceId) {
    if (instanceId) {
 ...
 * ```
 */
function setGridSizeCache(canvasId, containerWidth, config) {
    var _a, _b;
    // Build cache key (same logic as getGridSizeHorizontal)
    const cacheKey = (config === null || config === void 0 ? void 0 : config.instanceId)
        ? `${config.instanceId}-${canvasId}-h`
        : `${canvasId}-h`;
    // Get grid size percent from config or use default
    const gridSizePercent = (config === null || config === void 0 ? void 0 : config.gridSizePercent)
 ...
 * ```
 */
function getGridSizeHorizontal(canvasId, config, forceRecalc = false, domCacheInstance) {
    var _a, _b;
...
var gridCalculations = /*#__PURE__*/Object.freeze({
    __proto__: null,
    clearGridSizeCache: clearGridSizeCache,
    getGridSizeHorizontal: getGridSizeHorizontal,
    getGridSizeVertical: getGridSizeVertical,
    gridToPixelsX: gridToPixelsX,
    gridToPixelsY: gridToPixelsY,
    pixelsToGridX: pixelsToGridX,
    pixelsToGridY: pixelsToGridY,
    setGridSizeCache: setGridSizeCache
});

export { DOMCache as D, gridToPixelsX as a, gridToPixelsY as b, clearGridSizeCache as c, pixelsToGridY as d, getGridSizeHorizontal as e, gridCalculations as f, getGridSizeVertical as g, pixelsToGridX as p, setGridSizeCache as s };
//# sourceMappingURL=grid-calculations-C87xQzOc.js.map
