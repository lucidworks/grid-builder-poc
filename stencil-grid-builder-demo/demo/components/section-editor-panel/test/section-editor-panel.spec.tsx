...
describe("section-editor-panel", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should display section title in input", async () => {
      ...
      const titleInput = page.root.querySelector(
        ".section-title-input",
      ) as HTMLInputElement;
    ...
    it("should display background color in inputs", async () => {
      ...
      const colorInput = page.root.querySelector(
        ".section-color-input",
      ) as HTMLInputElement;
      const hexInput = page.root.querySelector(
        ".color-hex-input",
      ) as HTMLInputElement;
  ...
  describe("Cancel Functionality", () => {
    it("should emit closePanel event when cancel button clicked", async () => {
      ...
      const cancelBtn = page.root.querySelector(
        ".cancel-btn",
  ...
  describe("Delete Functionality", () => {
    it("should render delete button", async () => {
      ...
      const deleteBtn = page.root.querySelector(
        ".delete-btn",
      ) as HTMLButtonElement;
  ...
  describe("State Management", () => {
    ...
    it("should store original values when panel opens", async () => {
      ...
      expect(colorEventSpy.mock.calls[0][0].detail.backgroundColor).toBe(
        "#f0f4f8",
      );
    });
  });
