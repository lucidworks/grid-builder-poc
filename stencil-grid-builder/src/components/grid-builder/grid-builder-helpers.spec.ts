  ...
  describe('Canvas Event Handler Helpers', () => {
    describe('validateCanvasMoveSource', () => {
      ...
      it('should return null when canvas does not exist', () => {
        ...
        const result = component['validateCanvasMoveSource']('nonexistent', 'item-1');

        expect(result).toBeNull();
        expect(consoleSpy).toHaveBeenCalledWith('Source canvas not found:', 'nonexistent');
      ...
      it('should return null when item does not exist in canvas', () => {
        ...
        expect(result).toBeNull();
        expect(consoleSpy).toHaveBeenCalledWith('Item not found in source canvas:', 'item-1');
