...
| `apiRef`                  | --            | Custom API exposure configuration  **Optional prop**: Control where and how the Grid Builder API is exposed **Default**: `{ key: 'gridBuilderAPI' }` **Purpose**: Allows multiple grid-builder instances on the same page  **Options**: 1. **Custom key on window** (multiple instances): ```typescript <grid-builder api-ref={{ key: 'gridAPI1' }}></grid-builder> <grid-builder api-ref={{ key: 'gridAPI2' }}></grid-builder> // Access: window.gridAPI1, window.gridAPI2 ```  2. **Disable automatic exposure** (use ref instead): ```typescript <grid-builder api-ref={null}></grid-builder> // Access via ref: <grid-builder ref={el => this.api = el?.api}></grid-builder> ```                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `{ key?: string; }`                                                                                                                                                                                 | `{     key: "gridBuilderAPI",   }` |
