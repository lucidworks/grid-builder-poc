    ...
    'canvas1': {
      items: [
        ...
        },
        {
          ...
          zIndex: 2,
          config: { text: 'This layout was exported from grid-builder and imported to grid-viewer. Notice there are no editing controls - it\'s rendering-only!' },
        },
        {
          id: 'item-3',
          canvasId: 'canvas1',
...
export const BasicViewer = () => {
  ...
  return html`
    <div style="font-family: system-ui, -apple-system, sans-serif;">
      <h2 style="margin-top: 0; color: #333;">Grid Viewer - Display Only Mode</h2>
      <p style="color: #666; margin-bottom: 20px;">
        This is a rendering-only view. No drag-and-drop, no editing controls, just clean content display.
        <br />
...
export const ExportImportWorkflow = () => {
      ...
      'canvas1': {
        items: [
          ...
          },
          {
            ...
            zIndex: 2,
            config: { text: 'Try adding, moving, or editing components in the builder, then click Export to see the changes in the viewer below!' },
          },
        ],
        zIndexCounter: 3,
      },
  ...
  exportButton.addEventListener('click', async () => {
    try {
      ...
      console.log('✅ Successfully exported from builder and imported to viewer!');
    } catch (error) {
  ...
  return html`
    <div style="font-family: system-ui, -apple-system, sans-serif; padding: 20px;">
      ...
      <p style="color: #666;">
        This demonstrates the complete builder → viewer workflow.
        Edit the layout in the builder, then click the button to export and import to the viewer.
      </p>
      ...
      <div style="margin-bottom: 40px;">
        ...
        <div style="width: 100%; height: 400px; border: 3px solid #007bff; border-radius: 8px; overflow: hidden;">
          ${builderEl}
        </div>
        <p style="margin-top: 10px; font-size: 13px; color: #666;">
          <strong>Features:</strong> Drag-and-drop, resize, delete, undo/redo, config panel
          <br />
      ...
      <details style="margin: 20px 0;">
        <summary style="cursor: pointer; font-weight: 600; color: #333; padding: 10px; background: #f8f9fa; border-radius: 4px;">
          📋 View Exported JSON
        </summary>
        ${jsonDisplay}
      </details>
      ...
      <div>
        ...
        <div style="width: 100%; height: 400px; border: 3px solid #28a745; border-radius: 8px; overflow: hidden;">
          ${viewerContainer}
        </div>
        <p style="margin-top: 10px; font-size: 13px; color: #666;">
          <strong>Features:</strong> Clean display, responsive layouts, virtual rendering
          <br />
      ...
      <!-- Instructions -->
      <div style="margin-top: 40px; padding: 20px; background: #e7f3ff; border-left: 4px solid #007bff; border-radius: 4px;">
        ...
        <ol style="margin-bottom: 0; padding-left: 20px; line-height: 1.8;">
          ...
          <li>See the exact same layout in the viewer below (without editing controls)</li>
  ...
  const createViewer = (width, label) => {
    ...
    return html`
      <div style="margin-bottom: 30px;">
        ...
        <div style="width: ${width}px; height: 400px; border: 3px solid #17a2b8; border-radius: 8px; overflow: hidden;">
          ${viewerEl}
        </div>
        <p style="margin-top: 8px; font-size: 13px; color: #666;">
          Container width: <strong>${width}px</strong> → ${width < 768 ? 'Mobile' : 'Desktop'} viewport
        </p>
      </div>
    `;
  };
  ...
  return html`
    <div style="font-family: system-ui, -apple-system, sans-serif; padding: 20px;">
      ...
      <p style="color: #666; margin-bottom: 30px;">
        The viewer automatically switches between desktop and mobile viewports based on container width.
        <br />
      ...
      <div style="padding: 20px; background: #f8f9fa; border-radius: 8px; border-left: 4px solid #17a2b8;">
        ...
        <ul style="margin-bottom: 0; padding-left: 20px; line-height: 1.8;">
          <li>Viewport switching based on <strong>container width</strong>, not window width</li>
          <li>Works perfectly in sidebars, modals, or embedded widgets</li>
          <li>Multiple viewers can have different viewports on the same page</li>
...
export const MultipleSections = () => {
      ...
      'hero-section': {
        items: [
          ...
          },
          {
            ...
            zIndex: 2,
            config: { text: 'This hero section is the first canvas in a multi-section layout.' },
          },
        ],
      },
      'features-section': {
        items: [
          ...
          },
          {
            ...
            zIndex: 2,
            config: { text: '📦 Lightweight bundle - Only 30KB for viewer vs 150KB for builder' },
          },
          {
            id: 'feature-2',
            canvasId: 'features-section',
            ...
            zIndex: 3,
            config: { text: '📱 Responsive layouts - Auto-switch between desktop and mobile viewports' },
          },
          {
            id: 'feature-3',
            canvasId: 'features-section',
            ...
            zIndex: 4,
            config: { text: '🎨 Custom styling - Per-section background colors and theme support' },
          },
        ],
      },
      'cta-section': {
  ...
  return html`
    <div style="font-family: system-ui, -apple-system, sans-serif; padding: 20px;">
      ...
      <p style="color: #666; margin-bottom: 20px;">
        Grid-viewer can render multiple canvas sections vertically, each with its own background color.
        <br />
        This is perfect for creating landing pages with hero, features, testimonials, and CTA sections.
      </p>

      <div style="width: 100%; border: 2px solid #17a2b8; border-radius: 8px; overflow: hidden;">
        ${viewerEl}
      </div>

      <div style="margin-top: 20px; padding: 20px; background: #f8f9fa; border-radius: 8px; border-left: 4px solid #17a2b8;">
        <h4 style="margin-top: 0; color: #17a2b8;">📐 Section Structure</h4>
        <ul style="margin-bottom: 0; padding-left: 20px; line-height: 1.8;">
          <li><strong>Hero Section</strong> (light blue): Welcome header + description</li>
          <li><strong>Features Section</strong> (light green): 3 feature cards in a row</li>
          <li><strong>CTA Section</strong> (light yellow): Call-to-action text + button</li>
        </ul>
      </div>
    </div>
  `;
